...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <a href="../admin/add_recipe.php" class="btn btn-success">
...
<table class="table table-striped table-bordered">
    ...
    foreach ($ingredients as $ingredient) {
        echo "• " . htmlspecialchars(trim($ingredient)) . "<br>";
    }
    ?>
</td>
<td>
    ...
    foreach ($steps as $index => $step) {
        echo ($index + 1) . ". " . htmlspecialchars(trim($step)) . "<br>";
    }
    ?>
</td>

<td>
  <img src="../uploads/<?php echo $row['image']; ?>" alt="Recipe Image" style="width: 100px; height: auto;">
</td>
                </td>
                <td>
                    <a href="../admin/delete_recipe.php?id=<?= $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this recipe?');">
                        Delete
                    </a>
                </td>
            </tr>
